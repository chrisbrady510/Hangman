...
var word = [["Hangman", "The game you are playing right now."], 
["Christopher", "About the creator of this game."], 
["Winter", "From Decemeber 21 through March 21"], 
["Degree", "What you hope to earn in college"], 
["Mario", "Iconic 90's video game character, still relevant today"], 
["Pizza", "Favorite food of many people young and old"], 
["Samsung", "Major tech company which produces many android phones"], 
["San Jose", "Most populous city in Northern California and unofficial capital of Silicon Valley"], 
["Sleep", "Something you do while in bed"], 
["Clock", "Way to tell time"], 
["Sunny", "Often synoymous with peoples connotations of California"], 
["Hockey", "National sport of Canada that's gaining popularity in US"],
["Eagle", "Offical bird of the United States"], 
["Transporation", "How you get to work school or home is your mode of this"], 
["Consent", "Another word for agree"]
["Baseball", "America's unoffical pastime"]]
...
function gameEnd(e) {
    ...
    if(e) {
        ...
        gId("rM").innerHTML = "Congratulations, you solved the word!<br/><br/>You're amazing!"
    } else {
        gId("rT").innerText = "Sorry, you Lose! Better luck next time!"
        gId("rM").innerHTML = "The word was <br/><br/>\"" + word[select][0].toUpperCase() + "\"<br/><br/>Don't give up, practice makes perfect."
    }
    d.className = ""
}
